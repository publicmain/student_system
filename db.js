...
function createSchema() {
  ...
  const indexes = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_milestone_tasks_student ON milestone_tasks(student_id)',
    'CREATE INDEX IF NOT EXISTS idx_milestone_tasks_app ON milestone_tasks(application_id)',
    'CREATE INDEX IF NOT EXISTS idx_milestone_tasks_case ON milestone_tasks(intake_case_id)',
    'CREATE INDEX IF NOT EXISTS idx_material_items_student ON material_items(student_id)',
    'CREATE INDEX IF NOT EXISTS idx_material_items_app ON material_items(application_id)',
    ...
    'CREATE INDEX IF NOT EXISTS idx_mentor_assignments_staff ON mentor_assignments(staff_id)',
    ...
    'CREATE INDEX IF NOT EXISTS idx_intake_cases_student ON intake_cases(student_id)',
    'CREATE INDEX IF NOT EXISTS idx_mat_requests_case_dup ON mat_requests(intake_case_id)',
    'CREATE INDEX IF NOT EXISTS idx_mat_request_items_request ON mat_request_items(request_id)',
    'CREATE INDEX IF NOT EXISTS idx_file_exchange_records_case ON file_exchange_records(case_id)',
    'CREATE INDEX IF NOT EXISTS idx_commission_payouts_referral ON commission_payouts(referral_id)',
    'CREATE INDEX IF NOT EXISTS idx_commission_payouts_invoice ON commission_payouts(invoice_id)',
    'CREATE INDEX IF NOT EXISTS idx_finance_invoices_case ON finance_invoices(case_id)',
    'CREATE INDEX IF NOT EXISTS idx_essays_student_dup ON essays(student_id)',
    'CREATE INDEX IF NOT EXISTS idx_essay_versions_essay_dup ON essay_versions(essay_id)',
